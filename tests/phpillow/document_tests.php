...
class phpillowDocumentTests extends PHPUnit_Framework_TestCase
{
    ...
    public function testCreateSaveTwice()
    {
        $doc = phpillowUserDocument::createNew();
        $doc->login = 'kore';
        $doc->name = 'Kore';
        ...
        $doc->name = 'Kore (update1)';
        $doc->save();

        $doc->name = 'Kore (update2)';
        $doc->save();
    ...
    public function testCreateSaveModifySave()
    {
        $doc = phpillowUserDocument::createNew();
        $doc->login = 'kore';
        $doc->name = 'Kore';
        ...
        $fetchedDocument = phpillowManager::fetchDocument( 'user', 'user-kore' );
