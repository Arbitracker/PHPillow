 ...
 * @license http://www.gnu.org/licenses/gpl-3.0.txt GPL
 */
class phpillowBackendCouchDbArrayValidator extends phpillowBackendCouchDbValidator
{
    /**
    ...
    public function validate( $input )
    {
        if ( !is_array( $input ) )
        {
            throw new phpillowBackendCouchDbValidationException( 'Input is not an array.', array() );
        }
